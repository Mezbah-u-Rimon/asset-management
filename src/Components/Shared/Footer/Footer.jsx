...
import bgImg from "../../../assets/World Map.svg"
...
const Footer = () => {
    return (
        <div
            style={{ backgroundImage: `url('${bgImg}')`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center", }}
            className='w-full' >
            <footer className="relative w-full bg-[#10103aba] h-full">
                <div className="mx-auto w-full max-w-7xl px-8 text-white">
                    ...
                    <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
                        ...
                        >
                            &copy; {currentYear} Mezbah Uddin || All
                            Rights Reserved.
                        </Typography>
